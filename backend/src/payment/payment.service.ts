...
//             // 강의 회차의 잔여석 감소
//             payment.product_id -= createPaymentDto.;
...
//                     weekday: savedPayment.product.weekday,
//                     start_date: savedPayment.product.start_on,
//                     end_date: savedPayment.product.end_on,
//                     start_time: savedPayment.product.start_at,
//                     end_time: savedPayment.product.end_at,
//                 },
...
//             relations: ['product'], // 'product' 및 'livecast' 관계를 로드
//         });
...
//                 weekday: payment.product.weekday,
//                 start_date: payment.product.start_on,
//                 end_date: payment.product.end_on,
//                 start_time: payment.product.start_at,
//                 end_time: payment.product.end_at,
//             },
