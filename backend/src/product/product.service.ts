...
export class ProductService {
    ...
    async acceptProduct(id: number) {
        ...
        await this.elasticsearchService.indexDocument(index, {productname : product.name ,descirption : product.body , Instructor : Instructor.nickname , category : product.category, price : product.price , sale_price : product.sale_price , start : product.start_on , end : product.end_on, startTime : product.start_at , endTime : product.end_at })
