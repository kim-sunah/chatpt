...
const API_TOKEN = "https://hooks.slack.com/services/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"; //env에 달았던 웹 훅 url
...
const sendMessage = async (message: SlackMessageFormat) => {
  ...
  message.footer = `From API Server [Error_Log]`;
