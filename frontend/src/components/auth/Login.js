...
import naver from "../../img/btnG_완성형.png"
            ...
            <div className="rounded-lg border bg-card text-card-foreground shadow-lg" data-v0-t="card">
                ...
                <div className="p-6">
                    <div className="space-y-4">
                        ...
                        <img src={kakaoimage} style={{ width: "400px",height:"50px", cursor: "pointer" }} onClick={KakaoLogin}></img>
                        <img src={naver} style={{ width: "400px" , height:"50px"}} onClick={NaverLogin}></img>
