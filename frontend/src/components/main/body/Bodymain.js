            ...
            <section>
                ...
                <div className="flex flex-col sm:flex-row  hide-scrollbar mb-4" >
                    <div className="flex flex-col items-center mr-8">
                        <img onClick={() => setCategory('Posture')} src="https://chatpt-githubaction-s3-bucket.s3.ap-northeast-2.amazonaws.com/images/%EC%9E%90%EC%84%B8%EA%B5%90%EC%A0%95.png" className="relative flex shrink-0 overflow-hidden w-24 h-24 border rounded-full mb-2"></img>
                        <span className="text-lg">자세개선</span>
                    </div>
                    <div className="flex flex-col items-center mr-8">
                        <img onClick={() => setCategory('Yoga')} src="https://chatpt-githubaction-s3-bucket.s3.ap-northeast-2.amazonaws.com/images/%EC%9A%94%EA%B0%80.jpg" className="relative flex shrink-0 overflow-hidden w-24 h-24 border rounded-full mb-2"></img>
                        <span className="text-lg">요가</span>
                    </div>
                    <div className="flex flex-col items-center mr-8">
                        <img onClick={() => setCategory('Pilates')} src="https://chatpt-githubaction-s3-bucket.s3.ap-northeast-2.amazonaws.com/images/%ED%95%84%EB%9D%BC%ED%85%8C%EC%8A%A4.png" className="relative flex shrink-0 overflow-hidden w-24 h-24 border rounded-full mb-2"></img>
                        <span className="text-lg">필라테스</span>
                    </div>
                    <div className="flex flex-col items-center mr-8">
                        <img onClick={() => setCategory('Fitness')} src="https://chatpt-githubaction-s3-bucket.s3.ap-northeast-2.amazonaws.com/images/%ED%97%AC%EC%8A%A4.png" className="relative flex shrink-0 overflow-hidden w-24 h-24 border rounded-full mb-2"></img>
                        <span className="text-lg">헬스</span>
                    </div>
                    <div className="flex flex-col items-center mr-8">
                        <img onClick={() => setCategory('Ballet')} src="https://chatpt-githubaction-s3-bucket.s3.ap-northeast-2.amazonaws.com/images/%EB%B0%9C%EB%A0%88.png" className="relative flex shrink-0 overflow-hidden w-24 h-24 border rounded-full mb-2"></img>
