...
const TrainerPage = () => {
    ...
    useEffect(() => {
        Promise.all(
            products[0].map(async (product) => {
                const res = await fetch(`iamchatpiamchatpt.com:4430/rating/${product.id}`);
    ...
    const getUser = async () => {
        const res = await fetch('iamchatpiamchatpt.com:4430ypage', {
            method: 'GET',
    ...
    const getProduct = async () => {
        ...
        const res = await fetch(`iamchatpiamchatpt.com:4430/my?pageSize=100`, {
            method: 'GET',
            headers: {
                Authorization,
                refreshtoken,
    ...
    const getPayment = () => {
        ...
        const id = searchParams.get('id');
        return fetch(`iamchatpiamchatpt.com:4430/${product_Id}`, {
            method: 'GET',
            headers: { 'Content-Type': 'application/json', Authorization, refreshtoken },
        })
            .then((res) => {
    ...
    const getRevenue = async () => {
        ...
        try {
            const res = await fetch(`iamchatpiamchatpt.com:4430/revenue/${product_Id}`, {
                method: 'GET',
                headers: { 'Content-Type': 'application/json', Authorization, refreshtoken },
            });
            if (res.status === 200) {
    ...
    const getStudent = async () => {
        const res = await fetch(`iamchatpiamchatpt.com:4430/${product_Id}`, {});
