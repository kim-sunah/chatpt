...
const Trainerstart = () => {
    ...
    const HostHandler = () => {
        ...
        fetch("https://iamchatpt.com:444/users/Hostupdate", { method: "PUT", headers: { "Content-Type": "application/json", "Authorization": "Bearer " + sessionStorage.getItem("accessToken"), "refreshtoken": sessionStorage.getItem("refreshToken") } })
            .then(res => res.json())
