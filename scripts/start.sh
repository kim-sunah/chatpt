...
cd $ROOM_ROOT || { echo "Failed to change directory to $ROOM_ROOT"; exit 1; }

# npm install
$PM2_PATH start npm --name $ROOM_NAME -- start || { echo "Failed to start $REACT_APP_NAME"; exit 1; }
